...
const ko = {
  ...
  shell: {
    ...
    browse: "문서 둘러보기",
    title: "Comfort 가이드",
    description: "원칙부터 파운데이션, 컴포넌트까지 차례로 살펴보세요.",
  ...
  components: {
    eyebrow: "컴포넌트",
    title: "바로 확인하고 제품에 맞게 고쳐 쓰세요",
    description:
      "현재 사용하는 shadcn 컴포넌트의 동작, 상태, 접근성, 구현 위치를 한 페이지에서 확인할 수 있어요.",
    outlineFind: "컴포넌트 찾기",
    outlineExamples: "주요 컴포넌트",
    outlineDirectory: "종류별 전체 목록",
    coverageEyebrow: "전체 목록",
    coverageTitle: "8개 종류, 63개 컴포넌트",
    filtered: "검색 결과",
    featured: "먼저 살펴볼 컴포넌트",
    matching: (count) => `${count}개 컴포넌트를 찾았어요`,
    startTitle: "실제 동작부터 살펴보세요",
    emptyTitle: (query) => `“${query}”에 맞는 컴포넌트가 없어요`,
    emptyDescription:
      "더 넓은 쓰임새로 검색하거나 종류 선택을 초기화해 보세요.",
    reset: "검색 초기화",
    directoryEyebrow: "언제든 찾아보기",
    directoryTitle: "종류별 전체 목록",
  },
  componentDetail: {
    componentEyebrow: (family) => `${family} 컴포넌트`,
    preview: "미리보기와 코드",
    usage: "언제 쓰나요?",
    anatomy: "구성",
    variants: "변형",
    ...
    related: "함께 보기",
    usageEyebrow: "언제 쓰나요?",
    usageTitle: "해야 할 일과 결과가 분명해야 해요",
    variantsEyebrow: "조합 방법",
    variantsTitle: "모양이 달라도 사용법은 같게",
    variantDefault: "기본",
    variantDefaultDescription: "가장 자주 쓰는 흐름과 시맨틱 역할을 보여줘요.",
    variantFamilyDescription: (family) =>
      `${family}에서 함께 쓰는 동작을 따릅니다.`,
    variantComfortDescription:
      "시맨틱 토큰과 절제된 밀도, 빠짐없는 피드백을 사용해요.",
    statesEyebrow: "인터랙션 상태",
    statesTitle: "꼭 확인할 상태",
    accessibilityEyebrow: "누구나 사용할 수 있게",
    accessibilityTitle: "접근성 확인 항목",
    i18nEyebrow: "네 가지 언어",
    i18nItems: [
      "문구가 30% 길어져도 레이블과 컨트롤이 잘리지 않아야 해요.",
      "방향이 바뀌어도 안전하게 배치할 수 있도록 start와 end 기준을 사용하세요.",
      "컴포넌트 이름과 토큰 식별자는 유지하고 설명 문구만 자연스럽게 바꿔요.",
    ],
    implementationEyebrow: "프로젝트에 추가하기",
    implementationTitle: "코드 위치를 확인하세요",
    verifiedModule: "확인된 모듈",
    sourceAvailable: "소스 코드 제공",
    implementationDescription:
      "컴포넌트를 제품에 추가한 뒤에는 기능별 동작을 해당 기능 가까이에 두고, 공통 상태와 접근성 기준은 유지하세요.",
    snippetComment: "가이드에 정리된 구조와 상태로 내용을 구성하세요.",
    relatedEyebrow: "같은 종류",
    relatedTitle: "함께 살펴볼 컴포넌트",
    copy: "복사",
    copied: "복사했어요",
    previewTab: "미리보기",
    codeTab: "코드 보기",
    previewLabel: "컴포넌트 예시 보기",
    loading: "예시를 불러오는 중…",
    codeLabel: (title) => `${title} 코드 예시`,
  },
  legal: {
  ...
  notFound: {
    title: "페이지를 찾을 수 없어요",
    description:
      "홈으로 돌아가 원칙, 파운데이션, 컴포넌트에서 다시 찾아보세요.",
    action: "Comfort 홈으로",
  },
  families: {
    actions: "동작",
